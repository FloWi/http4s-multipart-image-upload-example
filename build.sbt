...
//avoid parallel execution because spark context might get confused otherwise
parallelExecution in ThisBuild := false

/********************** Compiler flags *******************/
val devMode = System.getProperty("dev", "false") == "true"

// reduce compiler errors during development
...
val strictAdditionalCompilerSettings =
  Seq(
